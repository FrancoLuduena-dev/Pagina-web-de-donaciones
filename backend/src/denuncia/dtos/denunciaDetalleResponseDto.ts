...
/**
 * Representación completa de una denuncia con información de resolución.
 */
export class DenunciaDetalleResponseDto {
  ...
  /**
   * Identificador del moderador asignado, si existe.
   */
  @ApiPropertyOptional({
  ...
  /**
   * Detalle explicativo de la resolución, si corresponde.
   */
  @ApiPropertyOptional({
    example:
      'Se pausó la publicación porque incumple las reglas de la plataforma.',
    description: 'Detalle de la resolución cargado por el moderador',
    nullable: true,
  })
  detalleResolucion?: string | null;

  /**
   * Fecha de resolución de la denuncia.
   */
  @ApiPropertyOptional({
    example: '2026-06-24T23:00:00.000Z',
    description: 'Fecha en la que se resolvió la denuncia',
    nullable: true,
  })
